      ...
      >
        <div className="flex w-full flex-col items-start gap-4">
          {/*
            ...
            The social row then uses mt-auto to absorb whatever slack is left over.
          ...
          <div className="flex w-full items-start justify-between gap-4 sm:gap-6 sm:px-10">
            <div className="flex min-h-[101.5px] min-w-0 flex-1 flex-col items-start sm:min-h-[133.5px]">
              ...
              <div className="mt-auto flex items-center gap-3">
                ...
                {/* The tip is absolutely positioned so its width never widens this
                    row — the badge alone holds the space. */}
                <div className="dock-note relative hidden items-center text-base sm:flex">
                  <button
                    type="button"
                    aria-label="Yes, these commits are squashed."
                    className="dock-note-badge hover:text-accent flex shrink-0 items-center justify-center rounded-lg bg-white/5 p-2 text-zinc-500 transition-colors hover:bg-white/10"
                  >
                    <svg
                      width="18"
                      height="18"
                  ...
                  <span aria-hidden="true" className="dock-note-tip text-shimmer whitespace-nowrap">
                    Yes, these commits are squashed.
                  </span>
                </div>
              </div>
            </div>
